            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="flex items-center gap-1.5">
                        <span className="w-3 h-3 rounded-sm" style={{ backgroundColor: layerColors.ifr }}></span>
                        <span>IFR Claims</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                        <span className="w-3 h-3 rounded-sm" style={{ backgroundColor: layerColors.cr }}></span>
                        <span>CR Claims</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                        <span className="w-3 h-3 rounded-sm" style={{ backgroundColor: layerColors.cfr }}></span>

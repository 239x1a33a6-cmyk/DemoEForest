  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">Interactive FRA Atlas</h3>
        ...
        <div className="lg:col-span-1">
          {selectedState ? (
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <h5 className="font-medium text-gray-900 mb-3">FRA Statistics</h5>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-6 border border-gray-200 text-center">
              ...
              <h4 className="text-lg font-medium text-gray-900 mb-2">Select a State</h4>
              <p className="text-sm text-gray-600">
                Click on any state in the map to view detailed information about FRA implementation and statistics.
              </p>
            </div>
          )}
        </div>

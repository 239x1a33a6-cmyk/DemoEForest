...
export interface ForestRightsData {
  state: string;
  stateCode: string;
  // Many historical entries in the source data use mixed shapes (objects or numbers/NA).
  // Use flexible / optional typing here to accommodate existing dataset shapes without breaking the build.
  claimsReceived?: any;
  claimsApproved?: any;
  claimsRejected?: any;
  titlesDistributed?: any;
  forestLandArea?: any;
  ...
  forestRightsTypes?: { ifr?: number; cfr?: number; cr?: number };
  ...
  claimsFiledAtGS?: any;
  claimsRecommendedToSDLC?: any;
  claimsRecommendedToDLC?: any;
  dlcApprovedClaims?: any;
  forestLandGiven?: any;
}

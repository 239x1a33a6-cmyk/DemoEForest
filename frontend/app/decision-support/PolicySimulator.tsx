        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <button
                    ...
                    disabled={loading}
                    className="mt-6 w-full px-6 py-3 bg-teal-600 text-white rounded-lg font-medium hover:bg-teal-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
                >
                    {loading ? (
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="text-center p-4 bg-teal-50 rounded-lg">
                                <div className="text-3xl font-bold text-teal-600">{simulationResult.impactSummary.totalVillagesAffected}</div>
                                <div className="text-sm text-gray-600 mt-1">Villages Affected</div>
                            </div>
                            <div className="text-center p-4 bg-emerald-50 rounded-lg">
                                <div className="text-3xl font-bold text-emerald-600">{simulationResult.impactSummary.avgPriorityChange.toFixed(1)}</div>
                                <div className="text-sm text-gray-600 mt-1">Avg Priority Change</div>
                            </div>
                            <div className="text-center p-4 bg-green-50 rounded-lg">
                                <div className="text-3xl font-bold text-green-600">₹{(simulationResult.budgetRequirement / 10000000).toFixed(1)}Cr</div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-96 overflow-y-auto">
                            {simulationResult.topPriorityVillages.map((village, idx) => (
                                <div key={village.id} className="bg-gradient-to-r from-teal-50 to-emerald-50 border border-teal-200 rounded-lg p-4">
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-1">
                                                <span className="bg-teal-600 text-white text-xs font-bold px-2 py-1 rounded">#{idx + 1}</span>
                                        ...
                                        <div className="text-right">
                                            <div className="text-lg font-bold text-teal-600">{village.vulnerabilityScores.overall.toFixed(1)}</div>

...
export const districtCentroids: Record<string, [number, number]> = {
    ...
    'Nizamabad': [78.0982, 18.6725],
    'Warangal': [79.5971, 17.9689],
    'Karimnagar': [79.1328, 18.4386],
    'Mahabubnagar': [77.9928, 16.7488],
    'Nalgonda': [79.2684, 17.0575],
    'Rangareddy': [78.4744, 17.3616],
    ...
    'Ganjam': [84.8427, 19.6060],
    'Gajapati': [84.1614, 18.9917],
    'Malkangiri': [81.8994, 18.3436],
    'Nabarangpur': [82.5516, 19.2278],
    'Kalahandi': [83.0833, 19.9167],
    ...
    'Chhindwara': [78.9322, 22.0574],
    'Seoni': [79.5486, 22.0869],
    'Balaghat': [80.1838, 21.8129],
    'Shahdol': [81.3582, 23.2936],
    'Anuppur': [81.6917, 23.1081],
    ...
    'Khowai': [91.6064, 24.0639],
    'Sepahijala': [91.3211, 23.6539],
    'Gomati': [91.5667, 23.5500],
    'Unakoti': [92.0333, 24.2333],
